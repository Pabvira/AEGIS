...
public class AEGIS {
    ...
    private static final String USUARIOS_CSV = "data/Integrantes.csv";
    private static final String RESERVAS_CSV = "data/Registros.csv";
    ...
    class LoginFrame extends JFrame {
        ...
        LoginFrame() {
            setTitle("Ingreso - AEGIS Reserva Estacionamiento");
        ...
        private void intentarIngreso() {
            ...
            if (u == null) {
                JOptionPane.showMessageDialog(this, "Correo no registrado en Integrantes.csv");
                return;
            }
